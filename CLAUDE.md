...
**図の種類を増やす規則: 行数＝図に載せる箇所の数。** 1箇所なら symmetry、離れた2箇所なら pair。図の形が表すのは「何箇所載るか」であって、何を見ているか（フレーム）ではない。**3つ目の形を足す前に、この規則で説明がつくかを必ず判定する**（倒置形も入れ子の弧で吸収できる。2026-08-02 確認）。
